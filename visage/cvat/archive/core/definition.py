...
project_create_parser = task_subparser.add_parser(
    'create_project',
    description='Create a new CVAT project.'
)
...
delete_projects_parser = task_subparser.add_parser(
    'delete_projects',
    description='Delete a CVAT project.'
)
delete_projects_parser.add_argument(
    'project_ids',
    type=int,
    help='list of projec IDs',
    nargs='+'
)
...
# List projects
#######################################################################
ls_projects_parser = task_subparser.add_parser(
    'ls_projects'#,
    #description='List all CVAT projects in simple or JSON format.'
    )
#######################################################################
# List
#######################################################################
